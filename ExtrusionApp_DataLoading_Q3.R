...
single_tari_parameter_data=cbind(single_tari_parameter_data[,1:which(colnames(single_tari_parameter_data)=="Start Time")-1],
                       temp,single_tari_parameter_data[,(which(colnames(single_tari_parameter_data)=="Start Time")+1):ncol(single_tari_parameter_data)],single_tari_parameter_data$`Start Time`)
names(single_tari_parameter_data)[length(single_tari_parameter_data)]<-"Start-Time" # contains of Date and Time
...
multi_tari_parameter_data=cbind(multi_tari_parameter_data[,1:which(colnames(multi_tari_parameter_data)=="Start Time")-1],
                                 temp,multi_tari_parameter_data[,(which(colnames(multi_tari_parameter_data)=="Start Time")+1):ncol(multi_tari_parameter_data)],multi_tari_parameter_data$`Start Time`)
names(multi_tari_parameter_data)[length(multi_tari_parameter_data)]<-"Start-Time"# contains of Date and Time
...
tapered_tari_parameter_data=cbind(tapered_tari_parameter_data[,1:which(colnames(tapered_tari_parameter_data)=="Start Time")-1],
                                 temp,tapered_tari_parameter_data[,(which(colnames(tapered_tari_parameter_data)=="Start Time")+1):ncol(tapered_tari_parameter_data)],tapered_tari_parameter_data$`Start Time`)
names(tapered_tari_parameter_data)[length(tapered_tari_parameter_data)]<-"Start-Time"# contains of Date and Time
